...
#define PLUGIN_VERSION			"1.0.20" //RIP Attachables
...
//	g_hCvarAdminOnly			= CreateConVar("tf_models_admin",			"0",	"Only administrators can use the models.",								CVAR_FLAGS);
	...
	g_hCvarAnnounce				= CreateConVar("tf_models_announce",		"0",	"Announces usage and tips about equippable models.",					CVAR_FLAGS);
	g_hCvarAnnouncePlugin		= CreateConVar("tf_models_announce_plugin",	"0",	"Announces information of the plugin when joining.",					CVAR_FLAGS);
...
public OnAllPluginsLoaded()
{
	...
	Donator_RegisterMenuItem("Set Model", ChangeModelCallBack);
}
// ------------------------------------------------------------------------
// OnPluginEnd()
// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
public DonatorMenu:ChangeModelCallBack(iClient)
{
