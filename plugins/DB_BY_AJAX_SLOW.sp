...
#define DEFAULT_SPEED_START 850.0
#define DEFAULT_SPEED_DEFLECT 250.0
#define DEFAULT_ORBIT_START 0.230
#define DEFAULT_ORBIT_DEFLECT 0.0175
#define DEFAULT_EVA_LIMIT 0.1
#define DEFAULT_EVA_RATE 0.1
...
new Float:EVA_LIMIT = DEFAULT_EVA_LIMIT;
new Float:EVA_RATE = DEFAULT_EVA_RATE;
...
public Action:ChangeParameter(client, args)
{
	...
	if (StrEqual(arg1, "EVA_LIMIT", false)) EVA_LIMIT = parameter_value;
	if (StrEqual(arg1, "EVA_RATE", false)) EVA_RATE = parameter_value;
